...
router.put('/campus/', async (ctx) => {
  ...
  const pool = mysql.promise();
  try {
    const [rows] = await pool.query(sql, [ctx.request.body.date, ctx.request.body.title]);
    ctx.response.body = { message: '', content: rows };
  } catch (err) {
    logger.error(err);
    ctx.response.body = { message: '服务器错误', content: '' };
...
router.delete('/recommend/:id', async (ctx) => {
  ...
  const pool = mysql.promise();
  try {
    await pool.execute(sql, [ctx.params.id, ctx.query.uuid]);
    ctx.response.body = { message: '', content: '' };
  } catch (err) {
    logger.error(err);
    ctx.response.body = { message: '服务器错误', content: '' };
...
router.put('/banner/', async (ctx) => {
  ...
  const pool = mysql.promise();
  try {
    const [rows] = await pool.query(sql, [ctx.request.body.category, ctx.request.body.status]);
    ctx.response.body = { message: '', content: rows };
  } catch (err) {
    logger.error(err);
    ctx.response.body = { message: '服务器错误', content: '' };
